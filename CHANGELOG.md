...
- **Modular CLAUDE.md** — Migrated to `.claude/CLAUDE.md` + modular `.claude/rules/` for architecture, coding standards, FM API patterns, and fork protection
...
- **Fork publish workflow** — `publish_fork.sh` one-command release pipeline
- **Separated scripts** — `scripts/release/`, `scripts/diagnostics/` by audience
- **Separated docs** — `docs/public/` (shipped with fork), `docs/internal/` (private only)
